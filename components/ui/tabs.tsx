...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "inline-flex h-9 w-full items-center justify-center rounded-lg bg-[#2a2148] p-1 text-zinc-400",
        className
      )}
      {...props}
    />
